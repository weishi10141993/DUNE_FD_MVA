...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   TString prefix = "NuTauClassification";
   ...
   TTree* theTree = (TTree*)input->Get("dataset/TestTree");
   theTree->SetBranchAddress("cvnnue",&cvnnue);
   theTree->SetBranchAddress("cvnnumu",&cvnnumu);
   theTree->SetBranchAddress("cvnnutau",&cvnnutau);
   theTree->SetBranchAddress("cvnnc",&cvnnc);
   theTree->SetBranchAddress("cvnnc",&cvnnc);
   theTree->SetBranchAddress("cvnnc",&cvnnc);
   theTree->SetBranchAddress("EHad",&eDepTotal);
